...
<html lang="en">
    <head>
        ...
        <title>Pengiriman | Dashboard</title>
                                    ...
                                    <tbody id="table-body">
                                        ...
                                        @csrf
                                            <tr>
                                                ...
                                                <td>{{$produk -> status}}</td>
                                                <td>
                                                    @if($produk->status === 'Menunggu Kurir' || $produk->status === 'Dalam Pengiriman' || $produk->status === 'Diterima Pelanggan')
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <form action="{{ url('edit')}}" method="POST" id="formPengiriman_{{ $produk->id }}">
                                                                        @csrf
                                                                        <input type="hidden" name="status" value="Dalam Pengiriman">
                                                                        <input type="hidden" name="idProduk" value="{{$produk->id}}">
                                                                        <a class="dropdown-item text-warning" href="#" onclick="submitForm('formPengiriman_{{ $produk->id }}')">Dalam Pengiriman</a>
                                                                    </form>
                                                                </li>
                                                                <li>
                                                                    <form action="{{ url('edit')}}" method="POST" id="formDiterima_{{ $produk->id }}">
                                                                        @csrf
                                                                        <input type="hidden" name="status" value="Diterima Pelanggan">
                                                                        <input type="hidden" name="idProduk" value="{{$produk->id}}">
                                                                        <a class="dropdown-item text-success" href="#" onclick="submitForm('formDiterima_{{ $produk->id }}')">Diterima Pelanggan</a>
                                                                    </form>
                                                                </li>
                                                                <!-- <li>
